...
<div class="clr"></div>
<br/>
<form id="appl_form" action="<? echo site_url('admin/save_user_account');?>" enctype="multipart/form-data" method="post">
...
<!--        <input id="present_year" name="present_year" class="text apply_datepickerx" readonly="readonly" value="<?php if (isset($student_details[0]->present_year))
    ...
    <li>
        ...
        <select id="section_id" name="section_id" class="text">
            <option value="">Select</option>
            <?php
...
<ol style="border:1px solid #ccc;">
	...
	<table width="100%"><tr>
       <td> <img src="<?if (isset($student_details[0]->photo))
                   echo base_url().'/'.$student_details[0]->photo;?>" width="125px" height="150" alt="<?if (isset($student_details[0]->photo))
                   echo base_url().'/'.$student_details[0]->photo;?>"/> <?//echo $student_details[0]->photo;?></td>
       <td> <img src="<?if (isset($student_details[0]->ssc))
                   echo base_url().'/'.$student_details[0]->ssc;?>" width="125px" height="150" alt="<?if (isset($student_details[0]->ssc))
                   echo base_url().'/'.$student_details[0]->ssc;?>"/> <?//echo $student_details[0]->ssc;?></td>
		<td> <img src="<?if (isset($student_details[0]->inter))
                   echo base_url().'/'.$student_details[0]->inter;?>" width="125px" height="150" alt="<?if (isset($student_details[0]->inter))
                   echo base_url().'/'.$student_details[0]->inter;?>"/><?//echo $student_details[0]->inter;?>
		</td>
	   <td> <img src="<?if (isset($student_details[0]->other))
                   echo base_url().'/'.$student_details[0]->other;?>" width="125px" height="150" alt="<?if (isset($student_details[0]->other))
                   echo base_url().'/'.$student_details[0]->other;?>"/><?//echo $student_details[0]->inter;?>
		</td>
	   </tr><tr>
	   <td><input type="file" name="photo" id="photo" size="20"/></td>
	   <td><input type="file" name="ssc" id="ssc"/></td>
	   <td><input type="file" name="inter" id="inter"/></td>
	   <td><input type="file" name="other" id="other"/></td>
	   </tr>
	   </table>
    </li>
