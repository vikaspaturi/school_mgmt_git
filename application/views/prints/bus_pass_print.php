...
<div style="border:2px solid; width:600px;position:relative;">
    ...
    <h5 style="width:105px; margin:0 auto;">College Bus Pass</h5>
<!--    <div>
        <img src="logo.png" width="50" height="50" style="position: absolute; top:60px; left:510px;">
    </div>-->
    <img src="<?php echo base_url(); ?>css/images/college_logo.png" height="60" style="position: absolute; top: 5px; right: 10px;">
