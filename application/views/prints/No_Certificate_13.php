<div style="border:2px solid; height:630px; width:750px;position:relative;">
    ...
    <div align=right style="margin-left:15px;margin-top: 30px;margin-right:15px">
        <h5 >Date: 26-10-2011</h5>
        <h5 >Unique Number: 05621A0420</h5>
    </div>
    <div>
    ...
    <div style="margin-left:15px;margin-top: 30px;margin-right:15px">
        ...
        <pre>Student Name	:	Rajeev Meanon</pre>
        <pre>Student Number	:	05621A0420</pre>
        <pre>Branch		:	ELECTRONICS & COMMUNICATION ENGINEERING</pre>
        <pre>Apporved By	:	I.V.S SASTRY</pre>
