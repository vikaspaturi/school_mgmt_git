<h2><span>List of the student who got highest marks in the particular subject.</span></h2>
<div class="clr"></div>
...
<!--            <p style="text-align:right;"><?php echo anchor('exam/downloadThisReport','<input type="button" class="button" value="Download Excel"/>');  ?></p>-->
            <p style="text-align:right;"><?php echo anchor('exam/report_highest_marks/true/'.urlsafe_b64encode(serialize($s_data)),'<input type="button" class="button" value="Download Excel"/>');  ?></p>
