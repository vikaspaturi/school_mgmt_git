...
<link href="<?php echo base_url();?>jquery-ui/css/smoothness/jquery-ui-1.10.3.custom.min.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?php echo base_url();?>jquery-ui/js/jquery-ui-1.10.3.custom.min.js"></script>
